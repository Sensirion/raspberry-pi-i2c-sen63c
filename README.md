# Sensirion Raspberry Pi I²C SEN63C Driver

The repository provides a driver for setting up a SEN63C sensor to run on a Raspberry Pi over I²C.
...
Use the following pins to connect your SEN63C:

| *SEN63C* | *Cable Color*  |   *Raspberry Pi*   |
| :----------------: | -------------- | ------------------ |
| VDD | red | Pin 1
| GND | black | Pin 6
| SDA | green | Pin 3
...
- Download the SEN63C driver from [Github](https://github.com/Sensirion/raspberry-pi-i2c-sen63c) and extract the `.zip` on your Raspberry Pi
- Connect the SEN63C sensor as explained in the [section above](#connect-the-sensor)

- Compile the driver
    1. Open a [terminal](https://projects.raspberrypi.org/en/projects/raspberry-pi-using/8)
    2. Navigate to the driver directory. E.g. `cd ~/raspberry-pi-i2c-sen63c`
    3. Navigate to the subdirectory example-usage.
    4. Run the `make` command to compile the driver

       Output:
       ```
       rm -f sen63c_i2c_example_usage
       cc -Os -Wall -fstrict-aliasing -Wstrict-aliasing=1 -Wsign-conversion -fPIC -I. -o sen63c_i2c_example_usage  sen63c_i2c.h sen63c_i2c.c sensirion_i2c_hal.h sensirion_i2c.h sensirion_i2c.c \
           sensirion_i2c_hal.c sensirion_config.h sensirion_common.h sensirion_common.c sen63c_i2c_example_usage.c
       ```
- Test your connected sensor
    - Run `./sen63c_i2c_example_usage` in the same directory you used to
...
If you run `./sen63c_i2c_example_usage` but do not get sensor readings but something like this instead
...
-   Ensure that your user account has read and write access to the I²C device.
    If it only works with user root (`sudo ./sen63c_i2c_example_usage`), it's
